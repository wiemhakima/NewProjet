...
const ActualiteSection = () => {
  ...
  const addToCart = (course) => {
    ...
    navigate('/user/Panier');  // Rediriger vers la page Panier après ajout au panier
  };
    ...
    <section className="py-24 bg-blue-50 dark:bg-gray-900">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex justify-center gap-y-8 lg:gap-y-0 flex-wrap md:flex-wrap lg:flex-nowrap lg:flex-row lg:justify-between lg:gap-x-8">
          {courses.map(course => (
            <div key={course.id} className="group w-full max-lg:max-w-xl dark:bg-gray-800 dark:text-gray-300 lg:w-1/3 border border-gray-300 dark:border-gray-700 rounded-2xl shadow-lg hover:shadow-xl transition-shadow duration-300 bg-white">
              ...
              <div className="p-6">
                ...
                <h4 className="text-xl text-blue-800 dark:text-white font-bold mb-3">{course.title}</h4>
                <p className="text-gray-600 dark:text-gray-400 leading-6 mb-4">{course.description}</p>
                <div className="mb-4">
